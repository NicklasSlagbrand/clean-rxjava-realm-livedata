...
class IsInstructionsShownUseCaseTest : AutoCloseKoinTest() {
    private val useCase: IsInstructionsShownUseCase by inject()
    ...
    fun `use case calls correct methods from data source`() {
        ...
        verify { dataSource.isInstructionsShownUseCase() }
    }
