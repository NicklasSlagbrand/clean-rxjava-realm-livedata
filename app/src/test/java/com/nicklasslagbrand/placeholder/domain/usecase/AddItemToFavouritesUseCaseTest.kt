...
class AddItemToFavouritesUseCaseTest : AutoCloseKoinTest() {
    private val useCase: AddItemToFavouritesUseCase by inject()
    ...
    fun `use case calls correct methods from data source`() {
        ...
        verify { dataSource.saveAttractionIdToFavourites(1) }
    }
