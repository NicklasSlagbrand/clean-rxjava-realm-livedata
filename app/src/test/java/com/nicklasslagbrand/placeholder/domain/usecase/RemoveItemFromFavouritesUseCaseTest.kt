...
class RemoveItemFromFavouritesUseCaseTest : AutoCloseKoinTest() {
    private val useCase: RemoveItemFromFavouritesUseCase by inject()
    ...
    fun `use case calls correct methods from data source`() {
        ...
        verify { dataSource.removeFavouriteByAttractionId(1) }
    }
